    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            if (typeof options.locale === 'object') {
                ...
                if (typeof options.locale.twYear === 'string') {
                    this.locale.twYear = options.locale.twYear;
                }

                if (typeof options.locale.twName === 'string') {
                    this.locale.twName = options.locale.twName;
                }

                if (typeof options.locale.localelang === 'string') {
                    this.locale.localelang = options.locale.localelang;
                }
            }
        ...
        updateFormInputs: function () {
            ...
            if (this.format.indexOf('R') === 0) {
                this.format=this.format.replace('R', this.startDate.format('YYYY') - 1911)
                this.container.find('input[name=daterangepicker_start]').val(this.startDate.format(this.format));
                this.container.find('input[name=daterangepicker_end]').val(this.endDate.format(this.format));
            }
            else {
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate, side) {
            ...
            if (this.locale.localelang==='tw') {
                var dateHtml = this.locale.twName + (calendar[1][1].year() - 1911) + this.locale.twYear + this.locale.monthNames[calendar[1][1].month()];
            }
            else {
                var dateHtml = this.locale.monthNames[calendar[1][1].month()] + calendar[1][1].format(" YYYY");
            }
